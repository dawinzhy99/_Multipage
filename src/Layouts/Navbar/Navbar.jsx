...
function Navbar({ tab, setTab, products, cart }) {
  return (
    <div className="navbar-container w-full mb-4">
      <nav className="navbar navbar-light bg-light w-full">
        <form className="container-fluid justify-content-around">
          ...
          <label className="swap swap-rotate ml-7">
